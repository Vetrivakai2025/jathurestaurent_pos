...
class SettingController extends Controller
{
    ...
    public function index()
    {
		...
		if ($user_auth->can('settings')){
            ...
            $payment_methods = PaymentMethod::where('deleted_at', '=', null)->get([ 'title']);
            $warehouses = Warehouse::where('deleted_at', '=', null)->get(['id', 'name']);
            
            return view('settings.system_settings_list', 
            compact('setting','backup_settings','email_settings','currencies','clients','payment_methods','warehouses','zones_array'));

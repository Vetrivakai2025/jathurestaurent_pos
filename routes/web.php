...
if ($installed === true) {
 ...
 Route::get('/sms', [SmsController::class, 'index'])->name('sms.index');
    ...
    Route::get('/sms/clients', [SmsController::class, 'getClients'])->name('sms.clients');
            ...
            // Route::prefix('inventory')->group(function() {
                ...
                Route::prefix('products')->group(function() {
                    ...
                    Route::get('/products/show_product_data/{id}/{variant_id}', 'ProductsController@show_product_data1' );

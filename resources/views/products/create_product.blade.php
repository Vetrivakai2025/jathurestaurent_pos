...
<div class="row" id="section_create_product">
  ...
  <div class="form-group col-md-4" v-if="product.type == 'is_single'">
    <label for="takeaway">Takeaway Cost <span class="field_required">*</span></label>
   <input type="number" class="form-control" id="takeaway" placeholder="Cost" 
    v-model="product.takeaway" min="0" step="0.01">

    <span class="error" v-if="errors && errors.takeaway">
        @{{ errors.takeaway[0] }}
    </span>
</div>
                                ...
                                <table class="table table-hover table-sm">
                                    <thead class="bg-gray-300">
                                        <tr>
                                            ...
                                            <th scope="col">{{ __('translate.Product_TakeAway') }}</th>
                                            <th scope="col"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr v-for="variant in variants">
                                           <td>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                <input required class="form-control" v-model="variant.takeaway">
                                            </td>
                                            <td>
